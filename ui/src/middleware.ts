...
const OSS_TOKEN_COOKIE = 'rooflyzer_auth_token';

// Paths that don't require authentication in OSS mode.
// `/embed` serves the public website widget (e.g. /embed/rooflyzer-widget.js),
...
export const config = {
  matcher: [
     ...
     * - public static assets (anything with a file extension, e.g. /rooflyzer-logo.png)
     */
