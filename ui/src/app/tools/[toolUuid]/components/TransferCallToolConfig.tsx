                    ...
                    >
                        ...
                        <TabsContent value="dynamic" className="space-y-5 mt-4">
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Rooflyzer sends the resolved argument dictionary to this endpoint. The endpoint must return transfer_context.destination and may return transfer_context.custom_message.{" "}
                                    <a
                            ...
                            <div className="grid gap-2">
                                ...
                                />
                                <Label className="text-xs text-muted-foreground">
                                    Rooflyzer sends a POST request with the resolved argument dictionary.
                                </Label>
                            </div>
                            ...
                            <div className="grid gap-2">
                                ...
                                />
                                <Label className="text-xs text-muted-foreground">
                                    Spoken while Rooflyzer waits for the resolver response.
                                </Label>
                            </div>
                            ...
                            <div className="grid gap-2 pt-4 border-t">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Add values Rooflyzer injects at runtime. These are not exposed to the LLM and can use templates like {`{{initial_context.state}}`} or {`{{gathered_context.state}}`}.{" "}
                                    <a
                                        href={`${DOCS_BASE}/voice-agent/tools/call-transfer#dynamic-resolver-request`}
                                        target="_blank"
                                        rel="noopener noreferrer"
