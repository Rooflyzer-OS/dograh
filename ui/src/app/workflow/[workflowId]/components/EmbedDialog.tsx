                ...
                const response = await createOrUpdateEmbedTokenApiV1WorkflowWorkflowIdEmbedTokenPost({
                    ...
                    body: {
                        ...
                        settings: {
                            ...
                            size: "medium",
                            autoStart: false,
                            containerId: embedMode === "inline" ? "rooflyzer-inline-container" : undefined,
                        },
                        usage_limit: null,
                                        ...
                                        <div className="space-y-3">
                                            <div className="rounded-lg bg-muted/50 p-4">
                                                ...
                                                <ul className="text-sm space-y-2 text-muted-foreground">
                                                    ...
                                                    <li>• Call <code className="text-xs">window.RooflyzerWidget.startChat()</code> to start a conversation (the agent greeting arrives via <code className="text-xs">onMessage</code>).</li>
                                                    <li>• Call <code className="text-xs">window.RooflyzerWidget.sendMessage(text)</code> to send a visitor message; it resolves with the updated transcript, or <code className="text-xs">null</code> if the message could not be delivered.</li>
                                                    <li>• Call <code className="text-xs">window.RooflyzerWidget.endChat()</code> to end the active conversation and trigger its completion webhook.</li>
                                                    ...
                                                    <li>• Call <code className="text-xs">window.RooflyzerWidget.setContext({"{ ... }"})</code> before <code className="text-xs">startChat()</code> to pass visitor details the page learned after load.</li>
                                                </ul>
                                            </div>
                                        ...
                                        <div className="space-y-3">
                                            <div className="rounded-lg bg-muted/50 p-4">
                                                ...
                                                <ul className="text-sm space-y-2 text-muted-foreground">
                                                    ...
                                                    <li>• Call <code className="text-xs">window.RooflyzerWidget.start()</code> to begin a call.</li>
                                                    <li>• Call <code className="text-xs">window.RooflyzerWidget.end()</code> to end it.</li>
                                                    ...
                                                    <li>• Call <code className="text-xs">window.RooflyzerWidget.setContext({"{ ... }"})</code> before <code className="text-xs">start()</code> to pass visitor details the page learned after load.</li>
                                                </ul>
                                            </div>
...
window.RooflyzerWidget?.onStatusChange((status) => {
  callStatus = status;
...
document.getElementById('talk-btn').addEventListener('click', () => {
  if (callStatus === 'connected' || callStatus === 'connecting') {
    window.RooflyzerWidget.end();
  } else {
    window.RooflyzerWidget.start();
  }
});`}</code>
                                                </pre>
  ...
  useEffect(() => {
    window.RooflyzerWidget?.onStatusChange(setStatus);
  }, []);

  const isLive = status === 'connected' || status === 'connecting';
  return (
    <button onClick={() => isLive ? window.RooflyzerWidget.end() : window.RooflyzerWidget.start()}>
                                    ...
                                    {embedMode === "inline" && (
                                        <div className="space-y-3">
                                            <div className="rounded-lg bg-muted/50 p-4">
                                                <h4 className="font-medium mb-2">Integration Instructions</h4>
                                                <ul className="text-sm space-y-2 text-muted-foreground">
                                                    <li>• Add a div with id=&quot;rooflyzer-inline-container&quot; where you want the widget</li>
                                                    ...
                                                    {widgetType === "chat" ? (
                                                        ...
                                                        <>
                                                            <li>• Call window.RooflyzerWidget.start() to begin the call</li>
                                                            <li>• Call window.RooflyzerWidget.end() to end the call</li>
                                                        </>
                                                    )}
                                                </ul>
                                            </div>
...
<div id="rooflyzer-inline-container" style="min-height: 480px">
  <!-- Chat panel renders here; no extra JS needed -->
                                                ...
                                                <div className="rounded-lg bg-blue-50 dark:bg-blue-950/20 p-4 border border-blue-200 dark:border-blue-800">
                                                    ...
                                                    <pre className="text-xs overflow-x-auto">
                                                        <code className="text-blue-800 dark:text-blue-200">{`export function RooflyzerAgent() {
  const [isCallActive, setIsCallActive] = useState(false);

  useEffect(() => {
    // Widget will auto-initialize when script loads
    window.RooflyzerWidget?.onCallStart(() => {
      setIsCallActive(true);
    });
    window.RooflyzerWidget?.onCallEnd(() => {
  ...
  return (
    <div className="my-8">
      ...
      <div id="rooflyzer-inline-container" className="min-h-[400px]">
        {/* Widget renders here */}
      </div>
      <button
        onClick={() => window.RooflyzerWidget?.start()}
                                    ...
                                    <>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                                ...
                                                <code className="text-xs">data-rooflyzer-context</code> values above — or call{" "}
                                                <code className="text-xs">{"window.RooflyzerWidget.setContext({ ... })"}</code> for
