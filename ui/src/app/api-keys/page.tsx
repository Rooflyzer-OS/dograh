            ...
            <div className="container mx-auto px-4 py-8">
                <div className="max-w-6xl mx-auto">
                    <div className="mb-8">
                        ...
                        <p className="text-muted-foreground">Manage your API keys to access Rooflyzer services programmatically</p>
                    </div>
                    ...
                    {/* Rooflyzer Service Keys Section */}
                    <Card className="mb-6">
                        <CardHeader>
                            <div className="flex justify-between items-center">
                                <div>
                                    <CardTitle>Rooflyzer Service Keys</CardTitle>
                                    <CardDescription>
                                        Manage service keys for accessing Rooflyzer AI services (LLM, TTS, STT)
                                    </CardDescription>
                                </div>
                                <div className="flex gap-2">
                                    ...
                                    {canCreateServiceKey ? (
                                        ...
                                        <span className="text">
                                            To generate additional service keys, <a href="https://app.rooflyzer.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Sign up on app.rooflyzer.com</a>
                                        </span>
                                    )}
                                </div>
                            </div>
            ...
            <Dialog open={isCreateServiceDialogOpen} onOpenChange={setIsCreateServiceDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Create a service key to access Rooflyzer AI services (LLM, TTS, STT)
                        </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                        <div className="grid gap-2">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                                <p className="text-sm text-blue-600 dark:text-blue-500">
                                    This key provides access to Rooflyzer AI services including LLM, Text-to-Speech, and Speech-to-Text.
