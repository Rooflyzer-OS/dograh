...
// Not part of the generated Rooflyzer SDK — a different host. All endpoints are PUBLIC
...
const BASE_URL = process.env.NEXT_PUBLIC_ONBOARDING_API_URL || "https://api-leads.rooflyzer.com";
